...
export interface ShareDayModalRef {
  present: () => void;
}
...
const ShareDayModal = forwardRef<ShareDayModalRef, ShareDayModalProps>(
  function ShareDayModal({ logs, date }, ref) {
